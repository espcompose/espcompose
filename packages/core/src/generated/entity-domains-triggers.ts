...
export const ENTITY_DOMAIN_TRIGGERS: Readonly<Record<string, Record<string, TriggerSignature>>> = {
  ...
  switch: {
    on_state: { variables: [{ name: "x", valueType: {"type":"bool"}, tsType: "boolean" }] },
    on_turn_on: { variables: [] },
    on_turn_off: { variables: [] },
  },
  sensor: {
    on_value: { variables: [{ name: "x", valueType: {"type":"float"}, tsType: "number" }] },
    on_raw_value: { variables: [{ name: "x", valueType: {"type":"float"}, tsType: "number" }] },
    on_value_range: { variables: [{ name: "x", valueType: {"type":"float"}, tsType: "number" }] },
  },
  binary_sensor: {
    on_state: { variables: [{ name: "x", valueType: {"type":"bool"}, tsType: "boolean" }] },
    on_press: { variables: [] },
  ...
  select: {
    on_value: { variables: [{ name: "x", valueType: {"type":"string"}, tsType: "string" }] },
  },
  text_sensor: {
    on_value: { variables: [{ name: "x", valueType: {"type":"string"}, tsType: "string" }] },
    on_raw_value: { variables: [{ name: "x", valueType: {"type":"string"}, tsType: "string" }] },
  },
  lock: {
    on_state: { variables: [] },
    on_lock: { variables: [] },
