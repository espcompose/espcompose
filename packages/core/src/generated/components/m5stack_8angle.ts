...
import type { __marker_i2c_I2CBus, __marker_m5stack_8angle_M5Stack8AngleComponent } from "../markers";
...
declare global {
    namespace JSX {
        interface IntrinsicElements {
            m5stack_8angle: M5stack8angleProps & ComponentProps<__marker_m5stack_8angle_M5Stack8AngleComponent>;
        }
    }
}
