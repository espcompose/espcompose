...
export interface ZigbeeProps extends _CoreComponent {
    ...
    /**
     * [Automation](https://esphome.io/automations#automation): Automation to run when the device joins the network.
     * @yamlKey on_join
     */
     ...
     */
    powerSource?: "BATTERY" | "DC_SOURCE" | "EMERGENCY_MAINS_CONST" | "EMERGENCY_MAINS_TRANSF" | "MAINS_SINGLE_PHASE" | "MAINS_THREE_PHASE" | "UNKNOWN";
    /**
