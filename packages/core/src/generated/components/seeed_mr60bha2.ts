...
import type { __marker_seeed_mr60bha2_MR60BHA2Component, __marker_uart_UARTComponent } from "../markers";
...
declare global {
    namespace JSX {
        interface IntrinsicElements {
            seeed_mr60bha2: SeeedMr60bha2Props & ComponentProps<__marker_seeed_mr60bha2_MR60BHA2Component>;
        }
    }
}
