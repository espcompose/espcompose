...
export interface Esp32FrameworkPropsAdvancedPropsSignedOtaVerificationProps {
    /** @yamlKey signing_key */
    signingKey?: unknown;
    /** @yamlKey signing_scheme */
    signingScheme?: "ecdsa256" | "rsa3072";
    /** @yamlKey verification_key */
    verificationKey?: unknown;
}
export interface Esp32FrameworkPropsAdvancedProps {
    /** @yamlKey adc_oneshot_in_iram */
    adcOneshotInIram?: boolean;
    ...
    /** @yamlKey signed_ota_verification */
    signedOtaVerification?: Esp32FrameworkPropsAdvancedPropsSignedOtaVerificationProps;
    /** @yamlKey sram1_as_iram */
    sram1AsIram?: boolean;
...
export interface Esp32FrameworkProps {
    ...
    /** @yamlKey log_level */
    logLevel?: "DEBUG" | "ERROR" | "INFO" | "NONE" | "VERBOSE" | "WARN";
...
export interface Esp32PartitionsProps {
    name: string;
    size: number;
    subtype: number;
    type: number;
...
export interface Esp32Props {
    ...
    /**
     * string: The CPU frequency to use. Defaults to the maximum supported frequency for the variant. The allowed values dep...
     * @yamlKey cpu_frequency
     */
    cpuFrequency?: "120MHZ" | "160MHZ" | "16MHZ" | "240MHZ" | "32MHZ" | "360MHZ" | "400MHZ" | "40MHZ" | "48MHZ" | "64MHZ" | "80MHZ" | "96MHZ";
    /**
     ...
     * @yamlKey flash_size
     */
    flashSize?: "16MB" | "2MB" | "32MB" | "4MB" | "8MB";
    ...
    /** filename or list: A partition table CSV file or a list of custom partitions to add. See [Partitions](https://esphome.... */
    partitions?: Array<Esp32PartitionsProps>;
