...
export { withGlobalScope, hashGlobalFingerprint, createGlobalHandle, createGlobalArrayHandle, irTypeToExprType, forwardControllerParamMeta, readControllerParamMeta } from './global-shared';
...
export type { OverlayController, OverlayFactory, OverlayConfig, OverlayDefinition, OverlayInstance, OverlayScopeResult, CapturedOverlayAction, ScriptParamGlobalDecl } from './useOverlay';
